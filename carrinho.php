            ...
            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list__initial">
                    ...
                    <form action="" class="search-form">
                        <input id="enter" type="search" placeholder="Busque por item ou produtor..." id="search-box">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="inputBox">
                ...
                <input type="text" placeholder="André Moutinho">
            </div>
            <div class="inputBox">
                <span>E-mail :</span>
                <input type="email" placeholder="andre@moutinho.com">
            </div>
            <div class="inputBox">
                <span>Cidade :</span>
            ...
            <div class="flex">
                ...
                <div class="inputBox">
                    <span>CEP :</span>
                    <input type="text" placeholder="11050-240">
                </div>
            </div>
...
padding: 12px 20px;">
        ...
        <footer class="section-p1">
            ...
            <div class="copyright">
                <p>© Copyright 2023 - Nattus - Todos os direitos reservados Nattus Comércio Alimentício LTDA</p></div>
        </footer>
        <!--=============== SCROLL UP ===============-->
