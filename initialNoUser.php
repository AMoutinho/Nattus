...
<body>
    ...
    <header class="header" id="header">
        <nav class="nav nav__container">
            ...
            <a href="initial.php" class="nav__logo first"> <i class="fa fa-leaf"></i>Nattus</a>

            <div class="nav__menu" id="nav-menu">
                <ul class="nav__list__initial">
                    <div></div>
                    <form action="" class="search-form">
                        <input id="enter" type="search" placeholder="Busque pelo item ou produtor..." id="search-box">
        ...
        <div class="shopping-cart cartes carts">
            ...
            <h3 class="total2"> Você não está logado(a). Clique no botão abaixo para fazer login e começar suas compras.</h3>
    ...
    <main class="main initial__home">
                ...
                <div class="initial__container grid">
                    <div class="content">
                        <div class="fist">
                            ...
                            <p>Nós levamos seu orgânico com qualidade Nattus que você já conhece, sem <br>
                                taxas abusivas. Incrível, não?</p>
                        </div>
                        <div class="inputs">
        ...
        <section class="banner section-m1">
            ...
            <span>Cupom oferece R$ 5,00 na compra de qualquer produto na plataforma.</span>
        ...
        <footer class="section-p1">
            <div class="col">
                <a href="index.html" class="nav__logo logo"> <i class="fa fa-leaf" style="color: #70C28D;"></i> Nattus </a>
                <h4>Contato</h4>
                <p><strong>Endereço:</strong> Rua Beco do Batman, S/N</p>
            ...
            <div class="copyright">
                <p>© Copyright 2023 - Nattus - Todos os direitos reservados Nattus Comércio Alimentício LTDA</p>
            </div>
        </footer>
        <!--=============== SCROLL UP ===============-->
