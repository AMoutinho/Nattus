    ...
    <div class="forms-container">
      <div class="signin-signup">
        ...
        <form action="#" method="POST" class="sign-up-form">
          ...
          <input type="submit" class="btn" value="Inscreva-se" name="sub" />
    ...
    <div class="panels-container">
      <div class="panel left-panel" style="display:unset;">
        ...
        <div class="content">
          <h3>Novo por aqui ?</h3>
          <p>
            Se registre na Nattus para ter acesso a nossa plataforma de compra e venda de alimentos orgânicos.
          </p>
      ...
      <a href="index.html" class="nav__logo"> <i class="fa fa-leaf"></i> Nattus </a>
        <div class="content">
          <h3>Já é de casa ?</h3>
          <p>
            Utilize sua conta já criada para ter acesso a nossa plataforma de compra de alimentos orgânicos.
          </p>
          <a href="login.php">
